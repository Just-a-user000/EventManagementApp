        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h3 class="mb-0"><i class="bi bi-plus-circle"></i> Crea Nuovo Evento</h3>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.events.store') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('event_type') is-invalid @enderror" 
                                    ...
                                    <option value="cultural" {{ old('event_type') == 'cultural' ? 'selected' : '' }}>Culturale</option>
                                    <option value="recreational" {{ old('event_type') == 'recreational' ? 'selected' : '' }}>Ricreativo</option>
                                    <option value="educational" {{ old('event_type') == 'educational' ? 'selected' : '' }}>Educativo</option>
                                    <option value="sports" {{ old('event_type') == 'sports' ? 'selected' : '' }}>Sportivo</option>
                                    <option value="other" {{ old('event_type') == 'other' ? 'selected' : '' }}>Altro</option>
                                </select>
                                @error('event_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="published" {{ old('status', 'published') == 'published' ? 'selected' : '' }}>Pubblicato</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            @error('registration_deadline')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Deve essere prima della data dell'evento</small>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('cost') is-invalid @enderror" 
                                       id="cost" name="cost" value="{{ old('cost') }}" min="0" step="0.01">
                                @error('cost')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Lascia vuoto se gratuito</small>
                            </div>
                        </div>
